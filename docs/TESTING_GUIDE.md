...
There is no committed Jest, Vitest, Playwright, or Cypress setup. Do not claim automated behavior coverage exists. For behavior changes, report manual verification explicitly until a runner is introduced.

## Proposed Test Convention

When adding the first automated tests, use:
