...
| BattleFlow Agent Runtime | `.agents/skills/battleflow-agent-runtime/SKILL.md` | Procedure for Claude Agent SDK runtime, workflow chat, node workspaces, prompt assembly, Claude auth, and agent tool permissions. |
