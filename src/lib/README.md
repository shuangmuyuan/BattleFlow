...
- Keep organization management mutations transactional and write audit events for role, membership, department/team, platform admin, and destructive changes.
