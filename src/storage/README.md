...
- `database/shared/schema.ts` defines Drizzle table schemas for organizations, Skills, workflows, workflow steps, snapshots, milestones, knowledge bases, knowledge documents, and PRD documents.
